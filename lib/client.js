...
let cc = Config.sessionName.replace(/Usman-Md;;;/g, "");
...
setTimeout(() => {
	...
	try{
		...
		console.log('Could not connect with Mongodb.\nPlease visit https://github.com/X-S-L-A-S-H-E-R/Secktor-2.0')
	}
    }
    main()
    //========================================================================================================================================
...
<html>
  ...
  <body>
    <section>
      Hello from NaveedDogar!
    </section>
  </body>
</html>
`
app.get("/", (req, res) => res.type('html').send(html));
app.listen(port, () => console.log(`Usman-Md Server listening on port http://localhost:${port}!`));
